		...
		protected function do_plugin_install() {
			...
			if ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] ) ) {
				...
				if ( $this->is_tgmpa_complete() ) {
					echo '<p>', sprintf( esc_html( $this->strings['complete'] ), '<a href="' . esc_url( admin_url('admin.php?page=getbowtied-dashboard') ) . '">' . esc_html( $this->strings['dashboard'] ) . '</a>' ), '</p>';
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		public function no_items() {
			echo esc_html__( 'No plugins to install, update or activate.', 'tgmpa' ) . ' <a href="' . esc_url( admin_url('admin.php?page=getbowtied-dashboard') ) . '"> ' . esc_html( $this->tgmpa->strings['dashboard'] ) . '</a>';
			//echo '<style type="text/css">#adminmenu .wp-submenu li.current { display: none !important; }</style>';
		}
		...
		public function process_bulk_actions() {
			...
			if ( 'tgmpa-bulk-activate' === $this->current_action() ) {
				...
				if ( isset( $_POST['plugin'] ) ) {
					$plugins = array_map( 'urldecode', array_map( 'sanitize_text_field', wp_unslash( (array) $_POST['plugin'] ) ) );
					...
					public function bulk_footer() {
						...
						if ( $this->tgmpa->is_tgmpa_complete() ) {
							...
							$update_actions['dashboard'] = sprintf(
								...
								'<a href="' . esc_url( admin_url('admin.php?page=getbowtied-dashboard') ) . '">' . esc_html( $this->tgmpa->strings['dashboard'] ) . '</a>'
							);
						} else {
